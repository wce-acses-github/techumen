...
function Footer() {
  ...
  return (
    <div className="footer-main-div bg-gradient-to-br from-blue-900 to-gray-900 text-gray-100 py-4 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Footer Info */}
        <div className="footer-info">
          <h1 className="text-2xl font-bold mb-2 text-white">WCE ACSES</h1>
        ...
        <div className="footer-contact-div">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
            <div>
              ...
              <input
                type="email"
                className="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500 text-sm"
            ...
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-1.5 rounded-lg text-sm transition duration-300 ease-in-out"
            >
              Submit
            </button>
          </form>
