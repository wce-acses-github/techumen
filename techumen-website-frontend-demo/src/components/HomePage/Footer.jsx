          ...
          <div className="footer-social-link flex space-x-3">
            <section className="flex justify-center items-center">
              ...
              >
                ...
                <span className="pointer-events-none absolute opacity-0 group-hover:opacity-100 group-hover:text-white-700 group-hover:text-sm group-hover:-translate-y-10 duration-700">
                  Discord
                </span>
              </button>
            </section>
            <section className="flex justify-center items-center">
              <button
                href="/"
                className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-[#0077b5] from-gray-800 to-black text-white font-semibold hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
            ...
            <section>
              <button
                href="/"
                className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-pink-500 to-yellow-500 text-white font-semibold hover:rounded-[50%] transition-all duration-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
