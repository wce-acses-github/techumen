        ...
        <div className="event-page-intro grid grid-rows-2 mb-2 sm:grid-cols-2 sm:grid-rows-1">
          ...
          <div className="event-page-intro-right flex flex-col justify-center text-gray-700">
            <p className="text-lg tajawal-font">
              An intense online coding contest where elite coders battle it out
              to solve algorithmic challenges. Sharpen your logic and compete
              for the top spot in this high-speed coding showdown.
            </p>
          </div>
        </div>
          ...
          >
            ...
            <p className="block w-full text-sm text-gray-500 p-4 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
              *If not able to submit through this you can fill the Google form
              on clicking the link below
            </p>

            {/* GfORM Button */}
            <div className="flex justify-center mt-6 acme-font">
              <a
                href="https://forms.gle/Jc7vFeFRrwow3oqS7"
                target="_blank"
