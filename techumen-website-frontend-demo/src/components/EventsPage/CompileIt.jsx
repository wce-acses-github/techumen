      ...
      <div className="event-page-main-div w-full max-w-3xl mx-auto my-10 p-6 bg-gray-50 rounded-lg shadow-lg relative">
        ...
        <div className="bg-white p-5 rounded-lg shadow-md">
          ...
          >
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col md:flex-row justify-between md:space-x-4 space-y-4 md:space-y-0">
                ...
                <div className="md:w-1/2 w-full flex justify-center items-center">
                  <img
                    src="https://res.cloudinary.com/domzgxu5n/image/upload/v1728204465/jl4hibf65oj8rnyvjh5f.jpg"
                    alt="QR Code"
                ...
                <div className="md:w-1/2 w-full flex justify-center items-center">
                  <img
                    src="https://res.cloudinary.com/daismmmjt/image/upload/v1728567562/lb9yylx4gunkpgypsozd.jpg"
                    alt="QR Code"
                    className="max-w-full h-80 rounded-lg"
                  />
                </div>
            ...
            <div className="flex justify-center mt-6 acme-font">
              <a
                href="https://forms.gle/imRpDqU5xGMyKF6c6"
                target="_blank"
